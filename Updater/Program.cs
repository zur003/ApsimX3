...
namespace Updater
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                if (Application.InitCheck("Updater", ref args))
                {
                    MessageDialog md = new MessageDialog(null, DialogFlags.Modal, MessageType.Error, ButtonsType.Ok, err.Message);
                    ///// md.Icon = new Gdk.Pixbuf(null, "Updater.Resources.apsim logo32.png");
                    md.Image = new Gtk.Image(Stock.DialogError, IconSize.Dnd);
                    md.Image.Show();
        ...
        private static void DoMacUpdate(string uninstallDirectory, string newInstallDirectory)
        {
            ...
            else
            {
                ...
                if (Application.InitCheck("Updater", ref args))
                {
                    MessageDialog md = new MessageDialog(null, DialogFlags.Modal, MessageType.Error, ButtonsType.Ok, "UpdateFailed");
                    md.Icon = new Gdk.Pixbuf(null, "Updater.Resources.apsim logo32.png");
                    md.Image = new Gtk.Image(Stock.DialogError, IconSize.Dnd);
                    md.Image.Show();
                    md.WindowPosition = WindowPosition.Center;
