    ...
    public class GridColumn : IGridColumn
    {
        ...
        public System.Drawing.Color HeaderBackgroundColour
        {
            get
            {
                ...
                if (button != null)
                {
                    Gdk.RGBA bg = button.StyleContext.GetBackgroundColor(StateFlags.Normal); // Style.Backgrounds[0];
                    return Color.FromArgb((int)(255 * bg.Alpha), (int)(255 * bg.Red), (int)(255 * bg.Green), (int)(255 * bg.Blue));
                }
                else
        ...
        public System.Drawing.Color HeaderForegroundColour
        {
            get
            {
                ...
                if (label != null)
                {
                    Gdk.RGBA fg = label.StyleContext.GetColor(StateFlags.Normal); // .Foregrounds[0];
                    return Color.FromArgb((int)(255 * fg.Alpha), (int)(255 * fg.Red), (int)(255 * fg.Green), (int)(255 * fg.Blue));
                }
                else
