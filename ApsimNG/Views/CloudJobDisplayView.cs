...
namespace UserInterface.Views
{
    public class CloudJobDisplayView : ViewBase
    {
        ...
        {
            get { return loadingProgress.Fraction * 100.0; } ///// Adjustment.Value; }
            set
            {
                ...
                Application.Invoke(delegate
                {
                    ...
                    loadingProgress.Fraction = Math.Min(Math.Round(value, 2) / 100.0, 1.0);
                });
            }
        }
        ...
        {
            get { return downloadProgress.Fraction; } ///// Adjustment.Value; }
            set
            {
                ...
                Invoke(delegate { downloadProgress.Fraction = Math.Min(Math.Round(value, 2), 1.0); });
            }
        }
        ...
        {
            Invoke(delegate { downloadProgressContainer.Hide(); });
        }
        ...
        {
            Application.Invoke(delegate { progress.Hide(); });
        }
