...
namespace UserInterface.Views
{
    ...
    public class DirectedGraphView : ViewBase
    {
        ...
        public System.Drawing.Image Export()
        {
            ...
            int width;
            int height;
            MainWidget.Window.GetGeometry(out x, out y, out width, out height);
            Gdk.Pixbuf screenshot = Gdk.PixbufHelper.GetFromWindow(drawable.Window, 0, 0, width - 20, height - 20); /////
            ///// Gdk.Pixbuf screenshot = Gdk.Pixbuf.FromDrawable(drawable.Window, drawable.Colormap, 0, 0, 0, 0, width - 20, height - 20);
        ...
        private void OnDrawingAreaExpose(object sender, DrawnArgs args)
        {
            try
            {
                ...
                Cairo.Context context = Gdk.CairoHelper.Create(area.Window);
