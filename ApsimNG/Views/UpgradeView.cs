    ...
    public class UpgradeView : ViewBase
    {
        ...
        private void AssertInputsAreValid()
        {
            if (string.IsNullOrWhiteSpace(firstNameBox.Text) || 
                ...
                string.IsNullOrWhiteSpace(countryBox.Entry.Text))
        ...
        private void WriteUpgradeRegistration(string version)
        {
            ...
            url = AddToURL(url, "country", countryBox.Entry.Text);
        ...
        private void OnFormClosing(object sender, EventArgs e)
        {
            try
            {
                ...
                Utility.Configuration.Settings.Country = countryBox.Entry.Text;
            }
            catch (Exception err)
            {
                ShowError(err);
